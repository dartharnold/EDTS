...
sys.stdout.flush()
eddb_systems_json = util.get_from_url(eddb_systems_url)
log.info("Done.")
log.info("Loading EDDB Systems data...")
sys.stdout.flush()
eddb_systems_obj = json.loads(eddb_systems_json.read())
log.info("Done.")
...
sys.stdout.flush()
eddb_stations_json = util.get_from_url(eddb_stations_url)
log.info("Done.")
log.info("Loading EDDB Stations data...")
sys.stdout.flush()
eddb_stations_obj = json.loads(eddb_stations_json.read())
log.info("Done.")
...
sys.stdout.flush()
coriolis_fsds_json = util.get_from_url(coriolis_fsds_url)
log.info("Done.")
log.info("Loading Coriolis FSD data...")
sys.stdout.flush()
coriolis_fsds_obj = json.loads(coriolis_fsds_json.read())
log.info("Done.")
